...
function Header(){
    return(
    <div className="flex flex-row h-20 w-12/12 content-center justify-end gap-11 px-9 py-5 fixed top-0 left-0 right-0 z-50 bg-[#030712]  max-[620px]:bg-black  max-[620px]:items-center  max-[620px]:flex-row">
